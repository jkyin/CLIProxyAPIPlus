...
type Handler struct {
	...
	tracingRecorder     tracing.Recorder
}
...
// SetTracingRecorder wires the optional tracing recorder used by management read APIs.
func (h *Handler) SetTracingRecorder(recorder tracing.Recorder) {
	h.tracingRecorder = recorder
}
