...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.GET("/tracing/requests", s.mgmt.GetTracingRequests)
		mgmt.GET("/tracing/request-summaries/stream", s.mgmt.TracingRequestSummariesStream)
		mgmt.GET("/tracing/requests/:request_id/detail", s.mgmt.GetTracingRequestDetail)
		mgmt.GET("/tracing/requests/:request_id/summary", s.mgmt.GetTracingRequestSummary)
		mgmt.DELETE("/tracing/requests/:request_id", s.mgmt.DeleteTracingRequest)
